    ...
    <div className="container">
      <div className="row">
          ...
          <div className="col-md-6 my-2">
            <div className={styles.analytics} style={{display:'flex',justifyContent:'space-between',backgroundColor:"rgb(246, 243, 243"}}>
          ...
          <div className="col-md-6 my-2">
            ...
            <p style={{fontSize:"20px",fontFamily:'Poppins',paddingTop:"20px",paddingLeft:"10px"}}>Total Reviews</p>
                </div>
          ...
          <div className="col-md-6 my-2">
          <div className={styles.analytics} style={{display:'flex',justifyContent:'space-between',backgroundColor:'#FEFFC0'}}>
