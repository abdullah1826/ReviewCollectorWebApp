  ...
  return (
    <div className={styles.containerFluid}>
      ...
      <div className="container">
        ...
        <div className={`row mb-4 ${styles.search}`} style={{position:"relative"}}>
          ...
          <div className="col-md-2" style={{width:"85px",position:"absolute",top:"0",right:'5px'}}>
            ...
            <MdTune
              ...
              <ul className="dropdown-menu" aria-labelledby="filterDropdown">
                {['All', 'excellent', 'good', 'fair', 'unsatisfactory'].map(option => (
                  <li key={option}>
                    <button
        ...
        >
          <div className="flex-grow-1 d-flex">
            <img
              ...
              height="60px"
            />
            <div style={{ height: "100px", overflow: "hidden", paddingRight: "3px" }}>
              <h5 className={styles.heading}>{reviews.name}</h5>
              <p className="card-text small text-muted">
                {reviews.feedback.length > 100
                  ? `${reviews.feedback.slice(0, 100)}...`
                  : reviews.feedback}
              </p>
            </div>
          </div>
          <div>
            ...
            <div className={styles.starRating} style={{ width: "100px" }}>
        ...
        {isModalOpen && (
          <div className={styles.modalOverlay} onClick={closeModal}>
            <div className={styles.modalContent} onClick={(e) => e.stopPropagation()}>
              ...
              <p style={{ fontSize: "18px", fontWeight: "600" }}>{selectReview.name}</p>
              <h5 style={{ fontSize: "17px", fontFamily: "Poppins", fontWeight: "400", color: '#8D8D8D' }}>Email</h5>
              <p style={{ fontSize: "18px", fontWeight: "600" }}>{selectReview.email}</p>
              <h5 style={{ fontSize: "17px", fontFamily: "Poppins", fontWeight: "400", color: '#8D8D8D' }}>Feedback</h5>
              <p style={{ fontSize: "18px", fontWeight: "600" }}>{selectReview.feedback}</p>
              <hr />
              <div style={{ display: "flex", justifyContent: 'space-between' }}>
                ...
                <button style={{ width: '115px',outline:'none', backgroundColor: '#FF9E9E', borderRadius: "17px", padding: "10px", border: 'none' }}>
                  {selectReview.option}
                </button>
              </div>
            </div>
